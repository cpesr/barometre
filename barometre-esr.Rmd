...
```{r, echo=FALSE, out.width="100%", fig.width=4.5,fig.height=4.5}
...
::: {.col data-latex="{0.3\textwidth}"}
```{r, echo=FALSE, out.width="100%", fig.width=4.5,fig.height=4.5}
plot_bloc_percent("PCinquietude",filldir=-1)
```
:::
::: {.col data-latex="{0.0\textwidth}"}
\ 
...
::: {.col data-latex="{0.3\textwidth}"}
```{r, echo=FALSE, out.width="100%", fig.width=4.5,fig.height=4.5}
plot_bloc_percent("PCimpact",filldir=-1)
```
:::
::: {.col data-latex="{0.0\textwidth}"}
\ 
...
```{r PCinquietude, fig.asp=5/16, fig.width=6}
plot_bloc("PCinquietude",pc.factor,filldir=-1,legend.position = "bottom-small")
```
...
```{r PCimpact, fig.asp=5/16, fig.width=6}
plot_bloc("PCimpact",pc.factor,filldir=-1,legend.position = "bottom-small")
```
:::
::::::
...
```{r PCeffort, fig.asp=5/16, fig.width=6}
  plot_bloc("PCeffort",pc.factor,legend.position = "bottom-small")
```
:::
::::::
...
plot_pops("categorie.grp","Dark2",90)
```
